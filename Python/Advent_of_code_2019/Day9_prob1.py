...
while inpt[i] != 99:
    ...
    if op_code == "01" or op_code == 1:
        ...
        p1 = cur[-3] if len(cur) >= 3 else "0"
        inpt[pm(inpt,p1,i,1 )] = int(input("Input required: "))
        i += 2 

    elif op_code == "04" or op_code == 4:
        p1 = cur[-3] if len(cur) >= 3 else "0"
        print("Output: " + str(inpt[pm(inpt,p1,i,1 )]))
        i += 2
